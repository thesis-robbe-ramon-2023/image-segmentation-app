...
export function line_intersects(p0, p1, p2, p3) {
...
export function check_intersect(x,y){
...
export function point_it(event) {
    if(complete){
    ...
    if(event.shiftKey || event.which === 3 || event.button === 2){
...
export function start(with_draw) {
    var img = new Image();
